module.exports = function(web3) {
  if (process.argv[4] === "--staging") {
    ...
    console.log(
      `Setting default account to the last account at web3.eth.accounts and unlocking it: ${account}`
    );
    ...
    console.log(
      `Setting default account to the last account at web3.eth.accounts: ${web3.eth.accounts.pop()}`
    );
